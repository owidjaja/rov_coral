...
if __name__ == "__main__":
    ...
    cv2.imshow("Old Aligned Mask in Main...", old_mask_aligned)
    cv2.imshow("New Aligned Mask in Main...", new_mask_aligned)

    cv2.imwrite("old_aligned.jpg", old_mask_aligned)
    cv2.imwrite("new_aligned.jpg", new_mask_aligned)
